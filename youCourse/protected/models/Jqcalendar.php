...
class Jqcalendar extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('IsAllDayEvent, userID', 'numerical', 'integerOnly'=>true),
			...
			array('Id, Subject, Location, Description, StartTime, EndTime, IsAllDayEvent, Color, RecurringRule, userID', 'safe', 'on'=>'search'),
		);
	}
