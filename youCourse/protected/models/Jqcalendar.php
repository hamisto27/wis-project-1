...
class Jqcalendar extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, IsAllDayEvent', 'required'),
			array('user_id, IsAllDayEvent', 'numerical', 'integerOnly'=>true),
			...
			array('Id, user_id, Subject, Location, Description, StartTime, EndTime, IsAllDayEvent, Color, RecurringRule', 'safe', 'on'=>'search'),
		);
	}
