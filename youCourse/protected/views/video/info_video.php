...
// Handle Youtube
    if (strpos($url, "youtube.com")) {
        ...
        $data['thumb_large'] = $json->data->thumbnail->sqDefault;
...
function get_youtube_video_image($url,$imagetype = 'hqdefault',$output_type='url'){
    ...
    if($output_type=='url'){
        ...
        return '<img alt="" src="http://i1.ytimg.com/vi/'.$get_video_code[1].'/'.$imagetype.'.jpg" />';
